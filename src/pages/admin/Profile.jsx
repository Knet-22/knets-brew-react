    ...
    <>
      ...
      <div className="profile-grid">
        <form onSubmit={saveProfile} className="data-card" style={{ padding: '1.8rem' }}>
          <h3 style={{ fontFamily: 'Inter, sans-serif', fontSize: '.8rem', fontWeight: 500, letterSpacing: '.22em', textTransform: 'uppercase', color: 'var(--gold)', marginBottom: '1rem' }}>
          ...
          <div className="form-group">
            <label>Role</label>
            <input type="text" className="form-control" value={staff.user_type} disabled style={{ textTransform: 'capitalize' }} />
          </div>
